...
// READ: 数组向指针退化 <https://cppreference.cn/w/cpp/language/array#%E6%95%B0%E7%BB%84%E5%88%B0%E6%8C%87%E9%92%88%E7%9A%84%E9%80%80%E5%8C%96>
bool is_fibonacci(int *ptr, int len, int stride) {
    ...
    for (int i = 0; i < len - 2; ++i) {
        int index = i * stride;
        int nextIndex = (i + 1) * stride;
        int nextNextIndex = (i + 2) * stride;
        if (ptr[nextNextIndex] != ptr[index] + ptr[nextIndex]) {
            return false;
        }
    }
    return true;
